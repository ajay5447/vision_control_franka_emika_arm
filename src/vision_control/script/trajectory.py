...
#     cv.imwrite('/home/ajay/catkin_ws/src/vision_control_ws/src/vision_control/joint_dataset/img%s.jpg' % i, frame)
#     # jointValues = data.position
#     # q1 = jointValues[0]
#     # q2 = jointValues[1]
#     with open('/home/ajay/catkin_ws/src/vision_control_ws/src/vision_control/joint_dataset/joint%s.csv' % i, 'w') as csvFile:
...
#     def __init__(self):
#         self.model = models.load_model('/home/ajay/catkin_ws/src/Visual-control-of-franka-emika-robot-manipulator/vision_model/model/end_model_1.h5')
